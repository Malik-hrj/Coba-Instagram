package com.example.cobainstagram.page.login
...
import com.example.cobainstagram.page.register.RegisterActivity
...
class LoginActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_signup_page.setOnClickListener {
    ...
    private fun loginUser() {
        ...
        when {
            ...
            TextUtils.isEmpty(password) -> Toast.makeText(this, "Password is Reuquired", Toast.LENGTH_SHORT).show()
