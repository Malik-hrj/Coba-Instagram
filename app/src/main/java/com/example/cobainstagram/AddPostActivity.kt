...
class AddPostActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE && resultCode == Activity.RESULT_OK && data!= null){
            ...
            imageUri = result.uri
            btn_add_post.setImageURI(imageUri)
        }
    }
    ...
    private fun uploadImagePost() {
        when {
            ...
            TextUtils.isEmpty(edt_at_caption.text.toString()) -> Toast.makeText(this,"abcdevg", Toast.LENGTH_SHORT)
                ...
                uploadTask.continueWithTask(Continuation <UploadTask. TaskSnapshot, Task<Uri>> { task ->
                    ...
                    if (task.isSuccessful){
                        ...
                        postMap["descriptions"] = edt_at_caption.text.toString()
